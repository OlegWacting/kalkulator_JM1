...
public class Main {
    public static void main(String[] args) throws CalculationException {
        ...
        String inputInfo = console.nextLine();        // считываем входные данные
        boolean addition = inputInfo.contains("+");              // есть в выражение сложение или нет
        if (addition == true){
        ...
        boolean subtraction = inputInfo.contains("-");           // есть в выражение вычитание или нет
        if (subtraction == true){
        ...
        boolean multiplication = inputInfo.contains("*");        // есть в выражение умножение или нет
        ...
        boolean division = inputInfo.contains("/");              // есть в выражение деление или нет
        if (division == true){
